...
async function loadEvents() {
    try {
        const res = await fetch('../php/home.php?accion=eventos');
...
async function loadCodes() {
    try {
        const res = await fetch('../php/home.php?accion=codes');
...
async function loadFeaturedCharacters() {
    try {
        const res = await fetch('../php/home.php?accion=featured_characters');
